...
/**
only when the number of stones is divisible by 4, the former player may loose the game.
in other condition, the former player can move the stones to make the left stones is divisible by 4.
*/
